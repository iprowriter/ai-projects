...
tools = [get_user_portfolio, get_live_prices, calculate_portfolio_worth]
...
async def llm_call(state: MessagesState):
    ...
    system_instruction = SystemMessage(
        content= """
        You are an Elite Portfolio Analytics Agent. You have access to Database to check stock portfolio of the user.

        You have the tool to check the current price of the stock

        You have the tool to calculate the worth of the user based on number of shares he has and their current prices
